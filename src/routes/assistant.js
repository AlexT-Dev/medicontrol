...
router.get('/deleteDate/:idpadactual', assistantController.deleteDate)    //Para borrar citas (cambiar el estado)
router.get('/restoreDate/:idpadactual&:idpaciente', assistantController.restoreDate)    //Para recuperar citas canceladas (cambiar el estado)
